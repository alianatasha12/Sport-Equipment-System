...
if(isset($_POST['login'])){
    ...
    $sel_username = "select * from login_staff where username='$username' AND password='$password'";
...
if($check_username==1){
    ...
    echo "<script>window.open('staff_halaman.php?logged_in=You Successfully Logged in!','_self')</script>";
    
    }
    else {
        echo "<script>alert('Staffid or Password is incorrect, try again')</script>";
