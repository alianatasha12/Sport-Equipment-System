...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="status_staff_penaltystudent.php">Status Penalty Student</a>
...
<h1></h1>
<center>
  <h2> UPDATE PENALTY OF SPORT EQUIPMENT(STAFF)</h2>
</center>
<br></br>
<?php
...
$status = "Record Updated Successfully. </br></br><a href='record_user_penalty.php'>View Updated Record </a>";
...
<p><input type="text" name="name" placeholder="" required value="<?php echo $row['approvaldate'];?>" /></p>
<p><input type="text" name="series" placeholder="" required value="<?php echo $row['return_date'];?>" /></p>
<p><input name="submit" type="submit" value="Calculate" /></p>
</form></center>
<center><p><input name="submit" type="submit" value="Update" /></p>
</form></center>
<?php } ?>
