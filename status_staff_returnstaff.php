...
<h1></h1>
<center>
<h2> Update Status Return Sport Equipment(Staff)</h2></center>
<br></br>
<center><label></label>
...
<td align="center"><a href="update_returnstaff.php?id=<?php echo $row['id']; ?>">Update_Return</a></td>
<td align="center"><a href="delete_returnstaff.php?id=<?php echo $row['id']; ?>">Delete</a></td></tr>
