...
<br></br>
<center>
  <h2> LIST OF SPORT EQUIPMENT BORROWING (STAFF)</h2>
</center>
<br></br>
<center><label></label>
...
if( isset($_GET['search']) ){
    ...
    $staffid = mysqli_real_escape_string($con, htmlspecialchars($_GET['search']));
     ...
     $sql = "SELECT * FROM application_staff INNER JOIN users ON application_staff.staffid = users.userID WHERE application_staff.staffid LIKE '%$staffid%' OR users.username LIKE '%$staffid%'";
