...
<h1></h1>
<center>
<h2> Update Status Penalty Sport Equipment</h2></center>
<br></br>
<center><label></label>
...
<tr>
  ...
  <th><strong>Staffid</strong></th><th><strong>Approval_Date</strong></th><th><strong>Return_Date</strong></th>
  <th><strong>Update_Penalty</strong></th><th><strong>Delete</strong></th></tr>
</thead>
<tbody>
<?php
$count=1;
...
$sql = "SELECT * FROM application_staff";
...
<td align="center"><a href=".php?id=<?php echo $row['id']; ?>">Penalty</a></td>
<td align="center"><a href="delete_penaltystaff.php?id=<?php echo $row['id']; ?>">Delete</a></td></tr>
